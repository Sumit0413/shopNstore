...
function MenuItem({ link, text, image }) {
  ...
  return (
    <div className="flex-1 relative overflow-hidden text-center shadow-[0_-1px_0_0_#fff]" ref={itemRef}>
      <a
        className="flex items-center justify-center h-full relative cursor-pointer uppercase no-underline  text-black text-[4vh] hover:text-[#060010] focus-visible:text-[#060010]"
        href={link}
